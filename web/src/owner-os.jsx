...
const PALETTES = {
  owner: {
    label: "Owner",
    bg: "#FBF8F5", panel: "#FFFFFF", panel2: "#F9F3ED",
    ink: "#2C2C2C", ink2: "#4A4A4A", muted: "#8A8A85",
    rule: "rgba(44,44,44,0.12)", ruleSoft: "rgba(44,44,44,0.07)",
    brick: "#088924", mustard: "#0A7D3A", forest: "#094413", plum: "#094413", signal: "#088924",
    radius: "14px", radiusSm: "8px",
    border: "1px solid rgba(44,44,44,0.12)",
    borderSoft: "1px solid rgba(44,44,44,0.07)",
    shadowHard: "0 10px 30px rgba(9,68,19,0.08), 0 1px 3px rgba(9,68,19,0.04)",
    shadowSoft: "0 4px 16px rgba(9,68,19,0.06)",
    shadowCard: "0 1px 3px rgba(44,44,44,0.05)",
    shadowCardHover: "0 6px 18px rgba(9,68,19,0.09)",
    shadowButton: "0 1px 2px rgba(9,68,19,0.10)",
    sans: "'STK Bureau Sans', 'Plus Jakarta Sans', 'Inter', system-ui, -apple-system, sans-serif",
